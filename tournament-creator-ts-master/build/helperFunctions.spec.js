...
const TournamentConfig_1 = require("../tournaments/TournamentConfig");
const StageConfig_1 = require("../stages/StageConfig");
const TournamentFactory_1 = require("../tournaments/TournamentFactory");
...
class TestHelperFunctions {
    ...
    static setMatches(tournament, bracket, phase) {
        ...
        for (let match of matches) {
            ...
            match.opponents[0].user = { id: TestHelperFunctions.tokenToId(match.opponents[0].token), username: username0 };
            match.opponents[1].user = { id: TestHelperFunctions.tokenToId(match.opponents[1].token), username: username1 };
            if (match.opponents[0].token == MatchFactory_1.MatchFactory.EMPTY_ENTRY.token) {
